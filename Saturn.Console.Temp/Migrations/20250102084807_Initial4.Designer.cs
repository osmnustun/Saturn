...
namespace Saturn.Console.Temp.Migrations
{
    ...
    [Migration("20250102084807_Initial4")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GroupStuedent", b =>
                {
                    b.Property<int>("GroupsGroupId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("StuedentsStudentId")
                        .HasColumnType("INTEGER");

                    b.HasKey("GroupsGroupId", "StuedentsStudentId");

                    b.HasIndex("StuedentsStudentId");

                    b.ToTable("GroupStuedent");
                });
            ...
            modelBuilder.Entity("GroupStuedent", b =>
                {
                    ...
                    b.HasOne("Saturn.Core.Entity.DatabaseEntities.Student", null)
                        .WithMany()
                        .HasForeignKey("StuedentsStudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
